...
<body>
    ...
    <div class="contenido">
        ...
        <section class="container first-container">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <p class="mt-5" data-i18n="home-description">
            ...
            <div class="row">
                <div class="col-6 col-lg-3">
                    <a href="historia.php" class="d-block p-5 mb-2 bg-secondary rounded text-white text-center">
                        ...
                        <p class="pt-3" data-i18n="home-buttons-history">Historia</p>
                    </a>
                </div>
                <div class="col-6 col-lg-3">
                    <a href="faq.php" class="d-block p-5 mb-2 bg-secondary rounded text-white text-center">
                        ...
                        <p class="pt-3" data-i18n="home-buttons-faq">FAQ</p>
                    </a>
                </div>
                <div class="col-6 col-lg-3">
                    <a href="estaciones.php" class="d-block p-5 mb-2 bg-secondary rounded text-white text-center">
                        ...
                        <p class="pt-3" data-i18n="home-buttons-stations">Estaciones</p>
                    </a>
                </div>
                <div class="col-6 col-lg-3">
        ...
        <section class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <h3 data-i18n="home-title-links">Ligas de interés</h3>
